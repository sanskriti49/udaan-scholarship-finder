...
function Hero() {
	return (
		<div className="font-pangea relative overflow-hidden bg-gradient-to-b from-white via-gray-50/50 to-white">
				...
				<div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-2 lg:gap-8">
					...
					<div className="flex justify-center lg:justify-end w-full pb-25">
						<div className="relative w-full max-w-2xl group">
							<div className="absolute inset-0 bg-gradient-to-tr from-emerald-600/10 to-blue-600/10 rounded-2xl transform rotate-2 scale-[1.02] -z-10 transition-transform group-hover:rotate-1 duration-300" />
