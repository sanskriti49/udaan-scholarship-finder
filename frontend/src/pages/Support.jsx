	...
	return (
		...
		>
			...
			>
				...
				<span
					className={`mt-0.5 w-[18px] h-[18px] shrink-0 rounded-full border-[1.5px] flex items-center justify-center transition-all duration-150 ${isOpen ? "bg-[#5AAD1F] border-[#5AAD1F]" : "border-gray-300"}`}
				>
					<svg
			...
			<div
				className={`grid transition-all duration-[280ms] ease-in-out ${isOpen ? "grid-rows-[1fr]" : "grid-rows-[0fr]"}`}
			>
						...
						>
							...
							<div className="flex flex-col gap-2">
								...
								<textarea
									...
									className="w-full bg-[#F6FAF1] border border-gray-200 rounded-xl px-4 py-3 text-[14px] outline-none focus:border-[#3B7DC8] focus:ring-2 focus:ring-[#3B7DC8]/10 transition resize-none min-h-[120px]"
								/>
							</div>
							...
							<div className="mt-6 flex justify-end">
								<button
									type="submit"
									className="cursor-pointer inline-flex items-center gap-2 px-8 py-3.5 rounded-xl
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="border border-gray-200/80 rounded-2xl p-6">
							...
							<div className="mb-4">
								...
								<textarea
									className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-[13px] outline-none focus:border-[#3B7DC8] resize-y min-h-[72px]"
							...
							<button className="inline-flex items-center gap-1.5 bg-[#FCEBEB] text-[#791F1F] text-[12px] font-bold px-4 py-2 rounded-full border-none cursor-pointer hover:bg-red-100 transition-colors">
								Submit report
							</button>
						</div>
						...
						<div className="border border-gray-200/80 rounded-2xl p-6">
							<div className="flex items-center gap-2.5 mb-3">
								...
								<h3 className="text-[15px] font-bold">Suggest a scholarship</h3>
							</div>
							<p className="text-[12.5px] text-gray-500 leading-relaxed mb-4">
							...
							<div className="mb-4">
								...
								<textarea
									className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-[13px] outline-none focus:border-[#3B7DC8] resize-y min-h-[44px]"
							...
							<button className="inline-flex items-center gap-1.5 bg-[#EAF3DE] text-[#27500A] text-[12px] font-bold px-4 py-2 rounded-full border-none cursor-pointer hover:bg-[#D4EBB0] transition-colors">
								+ Suggest scholarship
							</button>
						</div>
					</div>
