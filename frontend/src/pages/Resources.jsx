          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {GUIDES.map((guide, idx) => (
              ...
              >
                ...
                <div className="mt-5 flex items-center gap-1.5 text-[#5AAD1F] text-[13px] font-bold group-hover:gap-2.5 transition-all duration-200">
                  Read guide
                  <svg
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-gray-200/80 rounded-2xl p-7 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div className="mb-6">
              ...
              <h2 className="text-xl font-extrabold tracking-tight mt-1.5 mb-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {DOCUMENTS.map((doc, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-2.5 p-3 rounded-xl bg-[#F6FAF1] border border-[#DDECCB] hover:bg-[#EAF3DE] hover:border-[#C0DD97] transition-colors duration-150"
                >
                  <div className="w-5 h-5 rounded-full bg-[#EAF3DE] border border-[#C0DD97] text-[#5AAD1F] flex items-center justify-center shrink-0">
                    <svg
                      className="w-3 h-3"
                      fill="none"
                      stroke="currentColor"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {PORTALS.map((portal, idx) => (
              ...
              >
                ...
                />
                <span className="font-bold text-[14px] text-gray-800 pl-3 group-hover:pl-4 transition-all duration-200">
                  {portal.name}
                </span>
                <svg
      ...
      <section className="py-14 px-6 bg-[#F6FAF1] border-y border-[#DDECCB]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-8 items-start">
          <div>
            ...
            <h2 className="text-2xl font-extrabold tracking-tight mt-1.5 mb-2">
              Templates & downloads
            </h2>
            ...
            <button className="inline-flex items-center gap-2 bg-[#5AAD1F] hover:bg-[#4A9A18] active:bg-[#3D8813] text-white text-[13px] font-semibold px-6 py-3 rounded-full transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98]">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
      ...
      <section className="py-10 px-6">
        <div className="max-w-5xl mx-auto bg-[#EAF3DE] border border-[#C0DD97] rounded-2xl px-8 py-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3 shrink-0">
            <button className="w-full md:w-fit bg-[#5AAD1F] text-white text-[13px] font-semibold px-6 py-2.5 rounded-full hover:bg-[#4A9A18] active:bg-[#3D8813] transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98]">
              Check eligibility
            </button>
            <button className="w-full md:w-fit bg-white border border-[#C0DD97] text-[#27500A] text-[13px] font-semibold px-6 py-2.5 rounded-full hover:bg-[#F6FAF1] hover:border-[#5AAD1F] transition-all duration-200">
              Browse scholarships
            </button>
          </div>
        </div>
