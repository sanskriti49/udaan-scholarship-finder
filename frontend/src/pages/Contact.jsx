          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="h-full flex flex-col bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-10 relative group">
              ...
              >
                ...
                <button
                  type="submit"
                  className="mt-4 cursor-pointer w-full px-7 py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-md rounded-xl transition-all duration-200 shadow-md shadow-emerald-600/10 active:scale-[0.98]"
                >
                  Send Message
                </button>
              </form>
