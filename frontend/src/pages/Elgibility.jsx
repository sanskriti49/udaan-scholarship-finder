    ...
    <div className="min-h-screen bg-white text-gray-900 font-pangea">
                    ...
                    <div className="flex gap-2 h-11.5">
                      {["Male", "Female", "Other"].map((g) => (
                        <button
                          ...
                          className={`flex-1 rounded-xl text-[13px] font-semibold border transition-all duration-150 ${
                            formData.gender === g
            ...
            <div className="max-w-5xl mx-auto">
              ...
              {filteredResults.length > 0 ? (
                  ...
                  {filteredResults.map((s) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <button className="text-[13px] font-semibold text-[#5AAD1F] bg-[#EAF3DE] hover:bg-[#D4EBB0] px-4 py-2 rounded-full transition-colors duration-150">
                          View details
                        </button>
                      </div>
                    </div>
                ...
                <div className="bg-white border border-gray-200/80 rounded-2xl p-16 text-center shadow-sm">
                  ...
                  <button className="bg-[#5AAD1F] text-white text-[13px] font-semibold px-6 py-2.5 rounded-full hover:bg-[#4A9A18] transition-colors">
      ...
      <section className="py-8 px-6 border-t border-gray-100">
        <div className="max-w-5xl mx-auto bg-[#EAF3DE] border border-[#C0DD97] rounded-2xl px-8 py-7 flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
          ...
          <button className="shrink-0 bg-[#5AAD1F] text-white text-[13px] font-semibold px-6 py-2.5 rounded-full hover:bg-[#4A9A18] transition-colors">
